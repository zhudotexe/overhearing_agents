...
from funasr_detach.download.name_maps_from_hub import name_maps_hf, name_maps_ms
...
def get_or_download_model_dir(
    ...
    if os.path.exists(model) and check_latest:
        ...
        try:
            check_local_model_is_latest(model_cache_dir, user_agent={Invoke.KEY: key, ThirdParty.KEY: "funasr"})
        except:
