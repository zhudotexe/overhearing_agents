...
def cli():
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "optional patience value to use in beam decoding, as in https://arxiv.org/abs/2204.05424, the default (1.0)"
            " is equivalent to conventional beam search"
        ),
    )
    parser.add_argument(
        "--length_penalty",
        ...
        default=None,
        help=(
            "optional token length penalty coefficient (alpha) as in https://arxiv.org/abs/1609.08144, uses simple"
