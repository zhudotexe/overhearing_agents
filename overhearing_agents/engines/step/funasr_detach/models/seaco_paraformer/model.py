...
class SeacoParaformer(BiCifParaformer, Paraformer):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.train_decoder:
            loss_att, acc_att = self._calc_att_loss(encoder_out, encoder_out_lens, text, text_lengths)
    ...
    def _calc_seaco_loss(
        ...
        pre_acoustic_embeds, _, _, _ = self.predictor(encoder_out, ys_pad, encoder_out_mask, ignore_id=self.ignore_id)
        # decoder forward
