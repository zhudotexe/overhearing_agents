...
from funasr_detach.models.transformer.attention import LegacyRelPositionMultiHeadedAttention  # noqa: H301
from funasr_detach.models.transformer.attention import MultiHeadedAttention  # noqa: H301
from funasr_detach.models.transformer.attention import RelPositionMultiHeadedAttention  # noqa: H301
from funasr_detach.models.transformer.attention import (
    RelPositionMultiHeadedAttentionChunk,
)
from funasr_detach.models.transformer.embedding import LegacyRelPositionalEncoding  # noqa: H301
from funasr_detach.models.transformer.embedding import PositionalEncoding  # noqa: H301
from funasr_detach.models.transformer.embedding import RelPositionalEncoding  # noqa: H301
from funasr_detach.models.transformer.embedding import ScaledPositionalEncoding  # noqa: H301
...
from funasr_detach.models.transformer.utils.repeat import MultiBlocks, repeat
...
class ConformerChunkEncoder(torch.nn.Module):
    ...
    def forward(
        ...
        if self.unified_model_training:
            if self.training:
                chunk_size = (
                    self.default_chunk_size + torch.randint(-self.jitter_range, self.jitter_range + 1, (1,)).item()
                )
            else:
    ...
    def chunk_forward(
        ...
        if left_context > 0:
            processed_mask = torch.arange(left_context, device=x.device).view(1, left_context).flip(1)
