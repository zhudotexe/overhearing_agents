...
def add_arguments_rnn_encoder_common(group):
    ...
    group.add_argument(
        ...
        default="1",
        type=str,
        help="Subsample input frames x_y_z means subsample every x frame at 1st layer, every y frame at 2nd layer etc.",
    )
    return group
...
def add_arguments_rnn_attention_common(group):
    ...
    group.add_argument(
        ...
        type=int,
        help=(
            "Number of attention convolution channels                        (negative value indicates no"
    ...
    group.add_argument(
        ...
        type=int,
        help=(
            "Number of attention convolution filters                        (negative value indicates no location-aware"
            " attention)"
        ),
    )
    group.add_argument(
