...
from funasr_detach.train_utils.device_funcs import force_gatherable, to_device
        ...
        **kwargs,
        ...
        for mini_sentence_i in range(len(mini_sentences)):
            ...
            for i in range(len(mini_sentence)):
                if (
                    i == 0 or self.punc_list[punctuations[i - 1]] == "。" or self.punc_list[punctuations[i - 1]] == "？"
