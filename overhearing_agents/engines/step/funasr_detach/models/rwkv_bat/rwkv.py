...
class RWKV(torch.nn.Module):
    ...
    def __init__(
        ...
        self.att = EncoderSelfAttention(size, attention_size, context_size, block_id, att_dropout_rate, num_blocks)
...
class RWKVDecoderLayer(torch.nn.Module):
    ...
    def __init__(
        ...
        self.att = DecoderSelfAttention(size, attention_size, context_size, block_id, att_dropout_rate, num_blocks)
        self.dropout_att = torch.nn.Dropout(p=dropout_rate)
