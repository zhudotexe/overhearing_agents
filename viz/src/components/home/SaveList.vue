...
import SessionMetaRow from "@/components/home/SessionMetaRow.vue";
import { API } from "@/ts/api";
import type { SaveMeta } from "@/ts/models";
import { sorted } from "@/ts/utils";
  ...
  <nav class="panel">
        ...
        <div class="control">
          <div class="select">
            <select v-model="sortCompareFn">
              ...
              <option :value="(a: SaveMeta, b: SaveMeta) => b.created - a.created">Sort by creation date</option>
    ...
    <template v-if="!searchQuery">
      ...
      <RouterLink
        ...
        :to="{ name: 'save-chat', params: { saveId: save.id } }"
      >
        <span class="panel-icon">
